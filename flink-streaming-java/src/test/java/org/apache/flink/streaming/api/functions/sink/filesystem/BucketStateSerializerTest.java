...
public class BucketStateSerializerTest {
	...
	private static RowWisePartWriter.Factory<String, String> createBucketWriter() throws IOException {
		return new RowWisePartWriter.Factory<>(FileSystem.getLocalFileSystem().createRecoverableWriter(), new SimpleStringEncoder<>());
	}
