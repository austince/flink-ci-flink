...
public class StreamTwoInputProcessorFactory {
	public static <IN1, IN2> StreamTwoInputProcessor<IN1, IN2> create(
			...
			OperatorSubtaskState.VirtualChannelMapping virtualChannelMapping,
		...
		StreamTaskInput<IN1> input1 = RescalingStreamTaskNetworkInput.of(
		...
		StreamTaskInput<IN2> input2 = RescalingStreamTaskNetworkInput.of(
