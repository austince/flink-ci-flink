...
public class MesosTaskManagerParameters {
    ...
    public static final ConfigOption<Integer> MESOS_RM_TASKS_DISK_MB =
            key("mesos.resourcemanager.tasks.disk")
                    ...
                    .withDescription(
                            Description.builder()
                                    .text("Disk space to assign to the Mesos workers in MB.")
                                    .build());
    ...
    public static final ConfigOption<Integer> MESOS_RM_TASKS_NETWORK_MB_PER_SEC =
            key("mesos.resourcemanager.tasks.network.bandwidth")
                    ...
                    .withDescription(
                            Description.builder()
                                    .text(
                                            "Network bandwidth to assign to the Mesos workers in MB per sec.")
                                    .build());
    ...
    public static final ConfigOption<String> MESOS_RM_NETWORK_RESOURCE_NAME =
            key("mesos.resourcemanager.network.resource.name")
                    ...
                    .withDescription(
                            Description.builder()
                                    .text("Network resource name on Mesos cluster.")
                                    .build());
    ...
    public static final ConfigOption<Integer> MESOS_RM_TASKS_GPUS =
            key("mesos.resourcemanager.tasks.gpus")
                    ...
                    .withDescription(
                            Description.builder()
                                    .text("GPUs to assign to the Mesos workers.")
                                    .build());
    ...
    public static final ConfigOption<String> MESOS_TM_HOSTNAME =
            key("mesos.resourcemanager.tasks.hostname")
                    ...
                    .withDescription(
                            Description.builder()
                                    .text(
                                            "Optional value to define the TaskManager’s hostname. "
    ...
    public static final ConfigOption<String> MESOS_TM_USER =
            key("mesos.resourcemenager.tasks.user")
                    ...
                    .withDescription(
                            "Unix user which mesos tasks should run as. By default use the same user as jobmanager");
    ...
    public static final ConfigOption<String> MESOS_RM_CONTAINER_VOLUMES =
            key("mesos.resourcemanager.tasks.container.volumes")
                    .noDefaultValue()
                    .withDescription(
                            "A comma separated list of [host_path:]container_path[:RO|RW]. This allows for mounting"
    ...
    public static final ConfigOption<String> MESOS_RM_CONTAINER_DOCKER_PARAMETERS =
            key("mesos.resourcemanager.tasks.container.docker.parameters")
                    .noDefaultValue()
                    .withDescription(
                            "Custom parameters to be passed into docker run command when using the docker containerizer."
    ...
    public static final ConfigOption<Boolean> MESOS_RM_CONTAINER_DOCKER_FORCE_PULL_IMAGE =
            key("mesos.resourcemanager.tasks.container.docker.force-pull-image")
                    .defaultValue(false)
                    .withDescription(
                            "Instruct the docker containerizer to forcefully pull the image rather than"
    ...
    public static final ConfigOption<String> MESOS_CONSTRAINTS_HARD_HOSTATTR =
            key("mesos.constraints.hard.hostattribute")
                    ...
                    .withDescription(
                            Description.builder()
                                    .text(
                                            "Constraints for task placement on Mesos based on agent attributes. "
    ...
    /**
     * Value for {@code MESOS_RESOURCEMANAGER_TASKS_CONTAINER_TYPE} setting. Tells to use the Mesos
     * containerizer.
     */
    public static final String MESOS_RESOURCEMANAGER_TASKS_CONTAINER_TYPE_MESOS = "mesos";
    /**
     * Value for {@code MESOS_RESOURCEMANAGER_TASKS_CONTAINER_TYPE} setting. Tells to use the Docker
     * containerizer.
     */
    ...
    public static MesosTaskManagerParameters create(Configuration flinkConfig) {
        ...
        ContaineredTaskManagerParameters containeredParameters =
                createContaineredTaskManagerParameters(flinkConfig);

        int gpus = flinkConfig.getInteger(MESOS_RM_TASKS_GPUS);

        if (gpus < 0) {
            throw new IllegalConfigurationException(
                    MESOS_RM_TASKS_GPUS.key() + " cannot be negative");
        }
        ...
        switch (containerTypeString) {
            ...
            case MESOS_RESOURCEMANAGER_TASKS_CONTAINER_TYPE_DOCKER:
                ...
                if (imageName == null || imageName.length() == 0) {
                    throw new IllegalConfigurationException(
                            MESOS_RM_CONTAINER_IMAGE_NAME.key()
                                    + " must be specified for docker container type");
                }
                break;
            default:
                throw new IllegalConfigurationException(
                        "invalid container type: " + containerTypeString);
        }
        ...
        boolean dockerForcePullImage =
                flinkConfig.getBoolean(MESOS_RM_CONTAINER_DOCKER_FORCE_PULL_IMAGE);
    ...
    private static ContaineredTaskManagerParameters createContaineredTaskManagerParameters(
        ...
        return ContaineredTaskManagerParameters.create(flinkConfig, taskExecutorProcessSpec);
    }

    private static double getCpuCores(final Configuration configuration) {
        return TaskExecutorProcessUtils.getCpuCoresWithFallbackConfigOption(
                configuration, MESOS_RM_TASKS_CPUS);
    }
    ...
    private static void addHostAttrValueConstraint(
            List<ConstraintEvaluator> constraints,
    ...
    /**
     * Used to build volume specs for mesos. This allows for mounting additional volumes into a
     * container
     *
     * @param containerVolumes a comma delimited optional string of
     *     [host_path:]container_path[:RO|RW] that defines mount points for a container volume. If
     *     None or empty string, returns an empty iterator
     */
                    ...
                    switch (parts.length) {
                        ...
                        default:
                            throw new IllegalArgumentException(
                                    "volume specification is invalid, given: "
                                            + volumeSpecification);
                    }
    ...
    public static List<Protos.Parameter> buildDockerParameters(Option<String> dockerParameters) {
        if (dockerParameters.isEmpty()) {
            ...
            List<Protos.Parameter> parameters =
                    new ArrayList<>(dockerParameterSpecifications.length);
            ...
            for (String dockerParameterSpecification : dockerParameterSpecifications) {
                if (!dockerParameterSpecification.trim().isEmpty()) {
                    ...
                    if (match.length != 2) {
                        throw new IllegalArgumentException(
                                "Docker parameter specification is invalid, given: "
