...
public class ResourceSpecTest extends TestLogger {
    ...
    public void testEquals() throws Exception {
        ...
        ResourceSpec rs4 =
                ResourceSpec.newBuilder(1.0, 100)
                        .addExtendedResource(new ExternalResource(EXTERNAL_RESOURCE_NAME, 1))
                        .build();
    ...
    public void testSubtract() {
        ...
        final ResourceSpec rs2 =
                ResourceSpec.newBuilder(0.2, 100)
                        .addExtendedResource(new ExternalResource(EXTERNAL_RESOURCE_NAME, 0.5))
                        .build();
    ...
    public void testZeroExtendedResourceFromConstructor() {
        final ResourceSpec resourceSpec =
                ResourceSpec.newBuilder(1.0, 100)
                        .addExtendedResource(new ExternalResource(EXTERNAL_RESOURCE_NAME, 0))
                        .build();
