...
public abstract class PushLocalAggIntoTableSourceScanRuleBase extends RelOptRule {
    ...
    protected boolean isMatch(
        ...
        return tableSourceTable != null
                ...
                && Arrays.stream(tableSourceTable.extraDigests())
                        .noneMatch(str -> str.startsWith("aggregates=["));
    }
    ...
    protected void pushLocalAggregateIntoScan(
        ...
        DataType localAggOutputDataType =
                TypeConversions.fromLogicalToDataType(FlinkTypeFactory.toLogicalType(relDataType));
        ...
        boolean isPushDownSuccess =
                ((SupportsAggregatePushDown) newTableSource)
                        .applyAggregates(groupingSets, aggExpressions, localAggOutputDataType);
        ...
        TableSourceTable newTableSourceTable =
                oldTableSourceTable
                        .copy(newTableSource, newFlinkStatistic, newExtraDigests)
                        .copy(relDataType);
