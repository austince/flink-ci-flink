...
/**
 * Tests implementations for  {@link SerializationFormatFactory}.
 */
public class TestFormatSerializationOnlyFactory implements SerializationFormatFactory {

	public static final String IDENTIFIER = "test-format-serialization-only";
