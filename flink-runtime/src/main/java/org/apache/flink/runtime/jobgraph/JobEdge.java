...
public class JobEdge implements java.io.Serializable {
	...
	private ChannelStateRescaler downstreamChannelStateRescaler = ChannelStateRescaler.ROUND_ROBIN;

	/** The channel rescaler that should be used for this job edge on upstream side. */
	private ChannelStateRescaler upstreamChannelStateRescaler = ChannelStateRescaler.ROUND_ROBIN;
	...
	public ChannelStateRescaler getDownstreamChannelStateRescaler() {
		return downstreamChannelStateRescaler;
	}

	/**
	 * Sets the channel state rescaler used for rescaling persisted data on downstream side of this JobEdge.
	 *
	 * @param downstreamChannelStateRescaler The channel state rescaler selector to use.
	 */
	public void setDownstreamChannelStateRescaler(ChannelStateRescaler downstreamChannelStateRescaler) {
		this.downstreamChannelStateRescaler = checkNotNull(downstreamChannelStateRescaler);
	}
	...
	public ChannelStateRescaler getUpstreamChannelStateRescaler() {
		return upstreamChannelStateRescaler;
	}

	/**
	 * Sets the channel state rescaler used for rescaling persisted data on upstream side of this JobEdge.
	 *
	 * @param upstreamChannelStateRescaler The channel state rescaler selector to use.
	 */
	public void setUpstreamChannelStateRescaler(ChannelStateRescaler upstreamChannelStateRescaler) {
		this.upstreamChannelStateRescaler = checkNotNull(upstreamChannelStateRescaler);
	}
