...
public class PartitionedFileWriteReadTest {
    ...
    public void testWriteAndReadPartitionedFile() throws Exception {
        ...
        List<SortBuffer.BufferWithChannel>[] regionBuffers = new List[numSubpartitions];
        ...
        for (int region = 0; region < numRegions; ++region) {
            ...
            for (int i = 0; i < numBuffers; ++i) {
                ...
                regionBuffers[subpartition].add(
                        new SortBuffer.BufferWithChannel(buffer, subpartition));
            }
            ...
            for (int index = 0; index < numSubpartitions; ++index) {
                ...
                regionBuffers[subpartition].clear();
            }
        }
    ...
    private List<SortBuffer.BufferWithChannel> getBufferWithChannels(
            Buffer buffer, int channelIndex) {
        return Collections.singletonList(new SortBuffer.BufferWithChannel(buffer, channelIndex));
    }
