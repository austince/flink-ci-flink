 ...
 */
public class StartSchedulingBenchmarkTest extends TestLogger {

    @Test
    public void startSchedulingInStreamingJob() throws Exception {
        StartSchedulingBenchmark benchmark = new StartSchedulingBenchmark();
    ...
    @Test
    public void startSchedulingInBatchJob() throws Exception {
        StartSchedulingBenchmark benchmark = new StartSchedulingBenchmark();
