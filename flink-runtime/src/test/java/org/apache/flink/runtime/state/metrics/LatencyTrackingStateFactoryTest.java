...
public class LatencyTrackingStateFactoryTest {
    ...
    public <K, N> void testTrackValueState() {
    ...
    @Test
    @SuppressWarnings("unchecked")
    public <K, N> void testTrackListState() {
    ...
    @Test
    @SuppressWarnings("unchecked")
    public <K, N> void testTrackMapState() {
    ...
    @Test
    @SuppressWarnings("unchecked")
    public <K, N> void testTrackReducingState() {
    ...
    @Test
    @SuppressWarnings("unchecked")
    public <K, N> void testTrackAggregatingState() {
