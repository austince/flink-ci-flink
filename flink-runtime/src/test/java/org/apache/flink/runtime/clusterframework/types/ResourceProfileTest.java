...
public class ResourceProfileTest extends TestLogger {
    ...
    public void testAllFieldsNoLessThanProfile() {
        ...
        ResourceSpec rs1 =
                ResourceSpec.newBuilder(1.0, 100)
                        .addExtendedResource(new ExternalResource(EXTERNAL_RESOURCE_NAME, 2.2))
                        .build();
        ResourceSpec rs2 =
                ResourceSpec.newBuilder(1.0, 100)
                        .addExtendedResource(new ExternalResource(EXTERNAL_RESOURCE_NAME, 1.1))
                        .build();
    ...
    public void testMatchRequirement() {
        ...
        final ResourceProfile resource2 =
                ResourceProfile.newBuilder()
                        ...
                        .setTaskOffHeapMemoryMB(100)
                        .setManagedMemoryMB(100)
                        .addExtendedResource(new ExternalResource(EXTERNAL_RESOURCE_NAME, 1.0))
                        .build();
    ...
    public void testGet() {
        ResourceSpec rs =
                ResourceSpec.newBuilder(1.0, 100)
                        .addExtendedResource(new ExternalResource(EXTERNAL_RESOURCE_NAME, 1.6))
                        .build();
    ...
    public void testMerge() {
        ...
        final ResourceProfile rp2 =
                ResourceProfile.newBuilder()
                        ...
                        .addExtendedResource(new ExternalResource(EXTERNAL_RESOURCE_NAME, 2.0))
                        .build();
        ...
        final ResourceProfile rp2MergeRp2 =
                ResourceProfile.newBuilder()
                        ...
                        .addExtendedResource(new ExternalResource(EXTERNAL_RESOURCE_NAME, 4.0))
                        .build();
    ...
    public void testZeroExtendedResourceFromConstructor() {
        final ResourceProfile resourceProfile =
                ResourceProfile.newBuilder()
                        .addExtendedResource(new ExternalResource(EXTERNAL_RESOURCE_NAME, 0.0))
                        .build();
