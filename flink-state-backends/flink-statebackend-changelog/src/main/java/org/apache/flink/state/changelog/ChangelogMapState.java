...
class ChangelogMapState<K, N, UK, UV>
    ...
    public Iterable<Map.Entry<UK, UV>> entries() throws Exception {
        return loggingIterable(delegatedState.entries(), removeListener);
    }
    ...
    public Iterator<Map.Entry<UK, UV>> iterator() throws Exception {
        return loggingIterator(delegatedState.iterator(), removeListener);
    }
    ...
    private final BiConsumerWithException<
            ...
            removeListener = (entry, wrapper) -> serializeKey(entry.getKey(), wrapper);
}
